...
)
{
    ...
    //mergeRanksAndIndicesKernel<<<iDivUp(threadCount, 256), 256>>>(
    //mergeRanksAndIndicesKernel<<<iDivUp(threadCount, 32), 32>>>(
    //mergeRanksAndIndicesKernel<<<iDivUp(threadCount, 64), 64>>>(
    //mergeRanksAndIndicesKernel<<<iDivUp(threadCount, 128), 128>>>(
    //mergeRanksAndIndicesKernel<<<iDivUp(threadCount, 512), 512>>>(
    mergeRanksAndIndicesKernel<<<iDivUp(threadCount, 1024), 1024>>>(
        d_LimitsB,
        d_RanksB,
        stride,
        N,
